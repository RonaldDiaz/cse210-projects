public class Scripture 
{
    ...
    private static List<Scripture> _scripturesList =
    [
    ...
    public static Scripture GetScripture(int index)
    {
        ...
        return _scripturesList[index > 0 && index <= _scripturesList.Count ? index - 1 : new Random().Next(_scripturesList.Count)];
    }
    ...
    public static string GetScripturesMenu()
    {
        ...
        {
            menu += $"{i + 1}. {_scripturesList[i]._reference.GetDisplayText()}\n";
        }
        return menu;
    }
}